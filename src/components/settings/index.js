          ...
          <>
            <RootStyle {...varSidebar}>
              <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ py: 2, pr: 1, pl: 2.5 }}>
                <Typography variant="subtitle1">Visualización</Typography>
                <div>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Orientación</Typography>
                    <SettingLayout />
                  </Stack>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Comprimir</Typography>
                    <SettingStretch />
                  </Stack>
